 ...
 */
final class Version20260107053952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, google_id VARCHAR(255) DEFAULT NULL, active TINYINT(1) DEFAULT 1 NOT NULL, employment_type VARCHAR(255) DEFAULT NULL, hourly_rate NUMERIC(10, 2) DEFAULT NULL, consultation_fee NUMERIC(10, 2) DEFAULT NULL, default_currency VARCHAR(3) DEFAULT \'EUR\' NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
