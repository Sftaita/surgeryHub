...
**Dernier tag déployé : `v2026.08.05-prod-2` → commit `6e2b618`.**
Vérifié le 2026-08-05 par requêtes HTTP réelles sur le domaine public (pas
seulement par le tag — voir [`docs/deployment-versioning.md`](deployment-versioning.md)
§2.2) : `https://surgicalhub.be/icons/icon-32-v2.png` → `200`/`image/png`,
`index.html` servi référence bien `icon-16-v2.png`/`icon-32-v2.png`. Pour
