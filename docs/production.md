...
**Dernier tag déployé : `v2026.07.28-prod` → commit `690d30d`.**
...
ssh surgicalhub-prod "test -f /opt/stack/apps/surgicalhub/src/frontend/src/app/pages/manager/ProfilePage.tsx && echo PRESENT"
```
