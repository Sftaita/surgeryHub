...
**Dernier tag déployé : `v2026.07.13-prod` → commit `cfc9d530`.**
Vérifié le 2026-07-13 par marqueur de fichier réel sur le serveur (pas
...
ssh surgicalhub-prod "test -f /opt/stack/apps/surgicalhub/src/backend/src/Service/AbsenceMissionReactionService.php && echo PRESENT"
```
