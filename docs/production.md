...
**Dernier tag déployé : `v2026.07.31-prod-2` → commit `1f252b9`.**
...
ssh surgicalhub-prod "grep -l 'PLANNING_RESENT_MANUAL' /opt/stack/apps/surgicalhub/src/backend/src/Service/PlanningResendService.php && echo PRESENT"
```
