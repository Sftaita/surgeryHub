...
**Dernier tag déployé : `v2026.08.16-prod` → commit `3b42560`.**
Vérifié le 2026-08-16 par requêtes HTTP réelles sur le domaine public (pas
seulement par le tag — voir [`docs/deployment-versioning.md`](deployment-versioning.md)
§2.2) : login JWT réel, `POST/GET/PATCH` D-111 réels sur `api.surgicalhub.be`
