...
**Dernier tag déployé : `v2026.09.07-prod-2` → commit `f8327a1`.**
Vérifié le 2026-09-07 par requêtes HTTP réelles sur le domaine public (pas
seulement par le tag — voir [`docs/deployment-versioning.md`](deployment-versioning.md)
§2.2) : login JWT réel, `GET /api/me/available-rooms/count` réel sur
`api.surgicalhub.be` (voir historique ci-dessous pour le détail). Pour
confirmer à tout moment :
