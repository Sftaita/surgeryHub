...
**Dernier tag déployé : `v2026.07.17-prod` → commit `224893f`.**
Vérifié le 2026-07-17 par marqueur de fichier réel sur le serveur (pas
...
ssh surgicalhub-prod "test -f /opt/stack/apps/surgicalhub/src/backend/src/Service/PricingRuleWriteService.php && echo PRESENT"
```
