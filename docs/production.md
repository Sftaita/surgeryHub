...
**Dernier tag déployé : `v2026.07.13-prod-2` → commit `cd77520`.**
...
ssh surgicalhub-prod "test -f /opt/stack/apps/surgicalhub/src/backend/src/Service/UserEmailChangeService.php && echo PRESENT"
```
