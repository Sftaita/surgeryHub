...
**Dernier tag déployé : `v2026.07.28-prod-2` → commit `c6d1de3`.**
Vérifié le 2026-07-28 par marqueur de fichier réel sur le serveur (pas
...
ssh surgicalhub-prod "test -f /opt/stack/apps/surgicalhub/src/frontend/src/app/features/instrumentist-onboarding/InstrumentistOnboardingModal.tsx && echo PRESENT"
```
